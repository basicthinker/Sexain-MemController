...
for dir in ${simple_dirs[@]}; do
  $stats -d $dir -s sim_seconds system.mem_ctrls.bytes_written::writebacks \
system.l3cache.cache_flushes
done
...
bytes_written::total bytes_channel bytes_inter_channel num_epochs \
